...
public class Practica_Sumas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practica_sumas);
        ...
        estrellas = sharedPreferences.getInt("estrellas suma", 0);
        ...
        View.OnClickListener btnListener = v -> {
            ...
            new Handler().postDelayed(this::generarNuevaSuma, 2500);
        };
    ...
    private void generarNuevaSuma() {
        ...
        int opIncorrecta1 = sumaCorrecta + rand.nextInt(5) - 2;
        int opIncorrecta2 = sumaCorrecta + rand.nextInt(5) + 2;

        if (opIncorrecta1 == opIncorrecta2) {
            opIncorrecta2 += 1;
        }
        if (opIncorrecta2 == sumaCorrecta || opIncorrecta2 < 1) {
            opIncorrecta2 += 1;
        }

        List<Integer> opciones = Arrays.asList(sumaCorrecta, opIncorrecta1, opIncorrecta2);
    ...
    private void darEstrellas(){
        ...
        editor.putInt("estrellas suma", estrellas);
        editor.apply();
        txtEstrellas.setText(String.valueOf(estrellas));
    }
}